...
# # custom
# python run_rendering.py \
#     --work-dir /root/autodl-tmp/shape-of-motion/results/custom_2dgs/ \
#     --port 8091

# # sika
# python run_rendering.py \
#     --work-dir /root/autodl-tmp/shape-of-motion/results/sika/ \
#     --port 8091
...
python run_rendering.py \
    --work-dir /root/autodl-tmp/${model}/results/${name}/ \
    --port 8091
