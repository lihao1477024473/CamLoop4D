...
# paper-windmill
# python run_video.py \
#     --work_dir /root/autodl-tmp/shape-of-motion/results/paper-windmill \
...
# # custom_2dgs;cat
# python run_video.py \
#     --work_dir /root/autodl-tmp/shape-of-motion/results/custom \
...
# python run_video.py \
#     --work_dir /root/autodl-tmp/shape-of-motion/results/sika \
...
python run_video.py \
    --work_dir /root/autodl-tmp/som-change/results/${nameTrain} \
