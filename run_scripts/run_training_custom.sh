cd ..
 ...
 # python run_training.py \
  # --work-dir /root/autodl-tmp/shape-of-motion/results/custom \
  # --port 8080 \
  # data:custom \
...
#   dataName="sika"
# python run_training.py \
#   --work-dir /root/autodl-tmp/shape-of-motion/results/${dataName} \
#   --no-use_2dgs \
#   data:custom \
...
python run_training.py \
  --work-dir /root/autodl-tmp/${model}/results/${nameTrain} \
  --no-use_2dgs \
  data:custom \
  --data.data-dir /root/autodl-tmp/data/${dataDir} \
  --data.camera-type droid_recon \
