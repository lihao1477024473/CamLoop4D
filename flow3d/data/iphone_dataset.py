...
class iPhoneDataset(BaseDataset):
    def __init__(
        ...
        **_,
        ...
        # print(f"=====================self.camera_type================================================================================:{self.camera_type}")
        ...
        print(f"=====================================skip_load_imgs================================================================:{skip_load_imgs}")
        if not skip_load_imgs:
            ...
            # print(f"=============================================self.masks========================================================:{self.masks.shape}")
    ...
    # def get_masks(self, index: int) -> torch.Tensor: # 原来
    def get_mask(self, index: int) -> torch.Tensor: # lihao,修改（get_masks->get_mask），应该是作者笔误
        # print(f"index----self.masks===================================:{index} {self.masks.shape}")
