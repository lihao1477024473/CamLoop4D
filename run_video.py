        ...
        Annotated[
            ...
            tyro.conf.subcommand(
                ...
                default= CustomDataConfig(
                    seq_name="garden_flythrough_seva_16", # liaho
                    data_dir=tyro.MISSING,
                    load_from_cache=True,
                    skip_load_imgs=True, # lihao
                ),
            ),
        ]
        | Annotated[
...
def main(cfg: VideoConfig):
    ...
    print(f"train_dataset.num_frames:{train_dataset.num_frames} | renderer.num_frames:{renderer.num_frames}") # lihao
