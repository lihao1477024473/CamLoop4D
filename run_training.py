...
class TrainConfig:
    ...
    # num_bg: int = 100_000
    num_bg: int = 30_000 # lihao-mof，60_000,40_000
    # num_motion_bases: int = 10
    num_motion_bases: int = 6+4 # lihao,3,6,10,15,20,25,30;6+18
    num_epochs: int = 500 
...
def main(cfg: TrainConfig):
    ...
    print(f"lihao-mof==================device===========================:{device}")
    ...
    # print(f"lihao-mof==================initialize_and_checkpoint_model===========================")
    ...
    # print(f"lihao-mof==================Trainer.init_from_checkpoint===========================")
...
def initialize_and_checkpoint_model(
    ...
    print(f"[lihao-mof]motion_bases:\n{motion_bases},{type(motion_bases)} | motion_coefs={fg_params.params["motion_coefs"].shape} {type(fg_params.params["motion_coefs"])}")
    # exit(-1)
